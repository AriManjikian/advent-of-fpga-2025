...
Install opam (OCaml's package manager) following the [official installation guide](https://opam.ocaml.org/doc/Install.html).
...
```
### Installing Hardcaml
Install the OxCaml compiler switch:
```bash
...
I'm grateful that Jane Street created this Advent of FPGA challenge. I will definitely be returning to OCaml for another project in the future.
